...
Put the downloaded firmware binary into your radio SD card \FIRMWARE subfolder, and flash it to your radio either using EdgeTX bootloader, [EdgeTX Buddy](https://buddy.edgetx.org/) or [STM32CubeProgrammer](../troubleshooting/unbrick.md).

Use [EdgeTX Buddy](https://buddy.edgetx.org/) to fill your SD card appropriately for your radio.
