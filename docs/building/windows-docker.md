...
## Download and install [GWSL](https://github.com/Opticos/GWSL-Source/releases/) to run the Linux simulator
...
- the simulator won't have audio. If you need audio you might find [PulseAudio on WSL2](https://www.linuxuprising.com/2021/03/how-to-get-sound-pulseaudio-to-work-on.html) useful
